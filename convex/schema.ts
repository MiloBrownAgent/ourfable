...
export default defineSchema({
  ...
  ourfable_vault_before_born: defineTable({
    ...
    encryptedAnswer: v.optional(v.string()),
    answerContentHash: v.optional(v.string()),
    answerEncryptionVersion: v.optional(v.number()),
  ...
  ourfable_vault_birthday_letters: defineTable({
    ...
    encryptedParentNote: v.optional(v.string()),
    parentNoteContentHash: v.optional(v.string()),
    parentNoteEncryptionVersion: v.optional(v.number()),
    isSealed: v.boolean(),
    sealedUntilAge: v.number(),
    generatedAt: v.number(),
  })
