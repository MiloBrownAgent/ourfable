    ...
    <main className="min-h-screen flex items-center justify-center bg-brand-page-bg px-4">
      <div className="card max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-3xl font-bold mt-4 mb-1">Welcome back!</h1>
          <p className="text-brand-ink-muted text-sm">Sign in to continue your storytelling adventure</p>
        </div>

        {searchParams.get('error') && (
          <div className="bg-red-50 text-red-600 text-sm rounded-xl px-4 py-3 border border-red-200 mb-4">
        ...
        <p className="text-center text-sm text-brand-ink-muted mt-6">
          ...
          <Link href="/auth/signup" className="text-brand-purple font-bold hover:underline">Sign up free</Link>
        </p>
      </div>
    </main>
  );
