      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;">
        ...
        <tr><td style="background:#FFFFFF;border-radius:20px;border:1px solid #EAE7E1;overflow:hidden;">
          ...
          <table width="100%"><tr><td style="padding:44px;">
            ...
            <p style="margin:0 0 20px;font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',Arial,sans-serif;font-size:15px;color:#6B6860;line-height:1.8;">This is what you&apos;re building now: a private place where the people who matter most slowly leave behind letters, voice notes, photos, and videos your child will one day open.</p>
            <div style="background:#F8F5F0;border:1px solid #E8E4DE;border-radius:14px;padding:20px 24px;margin:0 0 28px;">
              <p style="margin:0 0 8px;font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',Arial,sans-serif;font-size:10px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;color:#8A8880;">Best next move</p>
              <p style="margin:0 0 8px;font-family:Georgia,'Times New Roman',serif;font-size:20px;font-weight:400;color:#1A1A18;line-height:1.5;">Invite the first 3–5 people who would write back.</p>
              <p style="margin:0;font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',Arial,sans-serif;font-size:14px;color:#6B6860;line-height:1.75;">Grandparents, aunts, uncles, godparents — anyone whose voice would matter years from now. Once they start replying, the vault begins compounding.</p>
            </div>
            <table cellpadding="0" cellspacing="0"><tr><td style="border-radius:100px;background:#4A5E4C;">
              <a href="https://ourfable.ai/${familyId}" style="display:inline-block;padding:13px 28px;font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',Arial,sans-serif;font-size:13px;font-weight:600;color:#FFFFFF;text-decoration:none;">Open your dashboard →</a>
            </td></tr></table>
