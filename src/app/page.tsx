...
export const metadata: Metadata = {
  ...
  description:
    "Record a letter, voice memo, or video for your child — delivered when they turn 13, 18, or 21. Our Fable asks the people who love them every month. Founding member rate: $79/year — limited to 1,000 families.",
